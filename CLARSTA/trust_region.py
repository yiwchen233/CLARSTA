...
This implementation is originally from Py-BOBYQA (https://github.com/numericalalgorithmsgroup/pybobyqa/blob/master/pybobyqa/trust_region.py).
'''
...
from .tools import sumsq, dykstra, pball, pbox
